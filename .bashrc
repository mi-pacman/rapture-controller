...
##########################
alias poweron-tc='sudo docker run -v /home/vagrant/.aws/credentials:/root/.aws/credentials:ro --name terraform_controller -h terraformController -v /home/vagrant/rapture-proxy/provisioner:/root -d -p 2222:22 midockerdb/terraform-controller:0.1.1'
...
###Packer Controller###
#######################
alias poweron-pc='sudo docker run -v /home/vagrant/.aws/credentials:/root/.aws/credentials:ro --name packer_controller -h packerController -v /home/vagrant/rapture-proxy/provisioner:/root -d -p 2223:22 midockerdb/packer-controller:0.1.1'
